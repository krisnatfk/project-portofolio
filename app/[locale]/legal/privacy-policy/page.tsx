...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Krisna Taufik's Portfolio App regarding TikTok API integration",
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            developer&apos;s (Krisna Taufik) public TikTok content for
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            contact the developer at: <strong>k1215na77@gmail.com</strong>.
          </p>
        </section>
      </div>
    </Container>
